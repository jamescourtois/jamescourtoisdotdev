...
<div class="w-full h-dvh flex flex-col items-center justify-center">
	...
	<div class="p-4 mx-auto text-center w-full">
			...
			<ul class="list-none flex gap-4 my-4 items-center justify-center">
				<li><a href="#samples" class="inline-block mt-2 text-xl cursor-pointer font-extrabold rounded-full bg-black dark:bg-white text-white dark:text-black px-8 py-4">Samples</a></li>
...
<div class="py-16 lg:py-24">
		...
		<form id="contact-form" action="https://api.form-data.com/f/JFPRHf1ZOogCA1" method="POST" class="lg:min-h-[490px] max-w-[800px] relative mx-auto p-16 border border-black dark:border-white">
				...
				<div class="w-full mb-6"><label for="message"
						...
						name="message" placeholder="e.g. Dear James, your code is perhaps the best code I've ever seen in my life..." required="required"
